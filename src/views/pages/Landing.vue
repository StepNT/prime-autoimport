        ...
        <div id="home" class="landing-wrapper overflow-hidden">
            <div class="relative mx-0 flex items-center justify-between px-6 py-6 lg:static lg:mx-20 md:mx-12 lg:px-20">
                <a class="flex items-center" href="#">
                    <svg viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-2 h-12">
                        <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                    ...
                    <span class="text-surface-900 dark:text-surface-0 mr-20 text-2xl font-medium leading-normal">SAKAI</span>
                </a>
                <Button
                ...
                <div class="bg-surface-0 dark:bg-surface-900 rounded-border absolute left-0 top-full z-20 hidden w-full grow items-center justify-between px-12 lg:static lg:flex lg:px-0">
                    <ul class="m-0 flex flex-col cursor-pointer select-none list-none gap-8 p-0 lg:flex-row lg:items-center">
                        <li>
                            <a class="text-surface-900 dark:text-surface-0 px-0 py-4 text-xl font-medium" @click="smoothScroll('#hero')">
                                <span>Home</span>
                            </a>
                        </li>
                        <li>
                            <a class="text-surface-900 dark:text-surface-0 px-0 py-4 text-xl font-medium" @click="smoothScroll('#features')">
                                <span>Features</span>
                            </a>
                        </li>
                        <li>
                            <a class="text-surface-900 dark:text-surface-0 px-0 py-4 text-xl font-medium" @click="smoothScroll('#highlights')">
                                <span>Highlights</span>
                            </a>
                        </li>
                        <li>
                            <a class="text-surface-900 dark:text-surface-0 px-0 py-4 text-xl font-medium" @click="smoothScroll('#pricing')">
                                <span>Pricing</span>
                            </a>
                        </li>
                    </ul>
                    <div class="border-surface mt-4 flex gap-2 border-t py-4 lg:mt-0 lg:border-t-0 lg:py-0">
            ...
            >
                <div class="mx-6 mt-0 md:mx-20 md:mt-6">
                    <h1 class="text-6xl text-gray-900 font-bold leading-tight">
                        <span class="block font-light">Eu sem integer</span>eget magna fermentum
                    </h1>
                    <p class="text-2xl text-gray-700 font-normal leading-normal md:mt-4">
                        Sed blandit libero volutpat sed cras. Fames ac turpis egestas integer. Placerat in egestas erat...
                    </p>
                    <Button label="Get Started" as="router-link" to="/" rounded class="mt-8 !px-4 !text-xl" />
                </div>
            ...
            <div id="features" class="mx-0 mt-8 px-6 py-6 lg:mx-20 lg:px-20">
                <div class="grid grid-cols-12 justify-center gap-4">
                    <div class="col-span-12 mb-6 mt-20 text-center">
                        <div class="text-surface-900 dark:text-surface-0 mb-2 text-4xl font-normal">
                            Marvelous Features
                        </div>
                    ...
                    <div class="col-span-12 mt-6 p-0 lg:col-span-4 md:col-span-12 lg:mt-0 lg:pb-8 lg:pr-8">
                        ...
                        >
                            <div class="bg-surface-0 dark:bg-surface-900 h-full p-4" style="border-radius: 8px">
                                ...
                                <h5 class="text-surface-900 dark:text-surface-0 mb-2">
                                    Easy to Use
                                </h5>
                    ...
                    <div class="col-span-12 mt-6 p-0 lg:col-span-4 md:col-span-12 lg:mt-0 lg:pb-8">
                        ...
                        >
                            <div class="bg-surface-0 dark:bg-surface-900 h-full p-4" style="border-radius: 8px">
                                ...
                                <div class="text-surface-900 dark:text-surface-0 mb-1 mt-6 text-xl font-semibold">
                                    Well Documented
                                </div>
                    ...
                    >
                        <div class="flex flex-col items-center justify-center px-4 py-4 text-center md:py-0">
                            <div class="mb-2 text-3xl text-gray-900 font-semibold">
                                Joséphine Miller
                            </div>
            ...
            <div id="highlights" class="mx-0 my-12 px-6 py-6 lg:mx-20 lg:px-20">
                ...
                <div class="grid grid-cols-12 mt-20 gap-4 pb-2 md:pb-20">
                    ...
                    <div class="col-span-12 my-auto flex flex-col gap-4 text-center lg:col-span-6 lg:items-end lg:text-right">
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-normal leading-none">
                            Congue Quisque Egestas
                        </div>
                        <span class="text-surface-700 dark:text-surface-100 ml-0 text-2xl leading-normal md:ml-2" style="max-width: 650px">Lectus arcu bibendum at varius vel pharetra vel turpis nunc. Eget aliquet nibh praesent tristique magna sit amet purus gravida. Sit amet mattis vulputate enim nulla aliquet.</span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-12 my-20 gap-4 pt-2 md:pt-20">
                    <div class="col-span-12 my-auto flex flex-col gap-4 text-center lg:col-span-6 lg:items-start lg:text-left">
                        ...
                        <span class="text-surface-700 dark:text-surface-100 mr-0 text-2xl leading-normal md:mr-2" style="max-width: 650px">Adipiscing commodo elit at imperdiet dui. Viverra nibh cras pulvinar mattis nunc sed blandit libero. Suspendisse in est ante in. Mauris pharetra et ultrices neque ornare aenean euismod elementum nisi.</span>
                    </div>
            ...
            <div id="pricing" class="my-2 px-6 py-6 md:my-6 lg:px-20">
                ...
                <div class="grid grid-cols-12 mt-20 justify-between gap-4 md:mt-0">
                        ...
                        <div class="border-surface-200 pricing-card hover:border-primary dark:border-surface-600 flex flex-col cursor-pointer border-2 p-4 transition-all duration-300" style="border-radius: 10px">
                            ...
                            <div class="my-8 flex flex-col items-center gap-4">
                                <div class="flex items-center">
                                    <span class="text-surface-900 dark:text-surface-0 mr-2 text-5xl font-bold">$0</span>
                            ...
                            <Divider class="bg-surface-200 w-full" />
                            <ul class="text-surface-900 dark:text-surface-0 my-8 flex flex-col list-none p-0 px-8">
                                <li class="py-2">
                                    <i class="pi pi-fw pi-check mr-2 text-xl text-cyan-500" />
                    ...
                    <div class="col-span-12 mt-6 p-0 lg:col-span-4 md:mt-0 md:p-4">
                        <div class="border-surface-200 dark:border-surface-600 pricing-card hover:border-primary flex flex-col cursor-pointer border-2 p-4 transition-all duration-300" style="border-radius: 10px">
                            <div class="text-surface-900 dark:text-surface-0 my-8 text-center text-3xl">
                                Startup
                            </div>
                            ...
                            <div class="my-8 flex flex-col items-center gap-4">
                                <div class="flex items-center">
                                    <span class="text-surface-900 dark:text-surface-0 mr-2 text-5xl font-bold">$1</span>
                                    <span class="text-surface-600 dark:text-surface-200">per month</span>
                                </div>
                                <Button label="Get Started" class="p-button-rounded ml-4 border-0 bg-blue-500 text-white font-light leading-tight" />
                            </div>
                    ...
                    <div class="col-span-12 mt-6 p-0 lg:col-span-4 md:mt-0 md:p-4">
                        <div class="border-surface-200 dark:border-surface-600 pricing-card hover:border-primary flex flex-col cursor-pointer border-2 p-4 transition-all duration-300" style="border-radius: 10px">
                            ...
                            <div class="my-8 flex flex-col items-center gap-4">
                                <div class="flex items-center">
                                    <span class="text-surface-900 dark:text-surface-0 mr-2 text-5xl font-bold">$5</span>
                                    <span class="text-surface-600 dark:text-surface-200">per month</span>
                                </div>
                                <Button label="Get Started" class="p-button-rounded ml-4 border-0 bg-blue-500 text-white font-light leading-tight" />
                            </div>
            ...
            <div class="mx-0 mt-20 px-6 py-6 lg:mx-20">
                <div class="grid grid-cols-12 gap-4">
                    <div class="col-span-12 md:col-span-2">
                        <a class="mb-4 flex flex-wrap cursor-pointer items-center justify-center md:mb-0 md:justify-start" @click="smoothScroll('#home')">
                            ...
                            <h4 class="text-surface-900 dark:text-surface-0 text-3xl font-medium">SAKAI</h4>
                        </a>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-10">
                        <div class="grid grid-cols-12 gap-8 text-center md:text-left">
                            <div class="col-span-12 md:col-span-3">
                                <h4 class="text-surface-900 dark:text-surface-0 mb-4 text-2xl font-medium leading-normal">
                                    Company
                                </h4>
                                <a class="text-surface-700 dark:text-surface-100 mb-2 block cursor-pointer text-xl leading-normal">About Us</a>
                                <a class="text-surface-700 dark:text-surface-100 mb-2 block cursor-pointer text-xl leading-normal">News</a>
                                <a class="text-surface-700 dark:text-surface-100 mb-2 block cursor-pointer text-xl leading-normal">Investor Relations</a>
                                <a class="text-surface-700 dark:text-surface-100 mb-2 block cursor-pointer text-xl leading-normal">Careers</a>
                                <a class="text-surface-700 dark:text-surface-100 block cursor-pointer text-xl leading-normal">Media Kit</a>
                            </div>
                            ...
                            <div class="col-span-12 md:col-span-3">
                                ...
                                <a class="text-surface-700 dark:text-surface-100 mb-2 block cursor-pointer text-xl leading-normal">Get Started</a>
                                <a class="text-surface-700 dark:text-surface-100 mb-2 block cursor-pointer text-xl leading-normal">Learn</a>
                                <a class="text-surface-700 dark:text-surface-100 block cursor-pointer text-xl leading-normal">Case Studies</a>
                            </div>
                            ...
                            <div class="col-span-12 md:col-span-3">
                                ...
                                <a class="text-surface-700 dark:text-surface-100 mb-2 block cursor-pointer text-xl leading-normal">Discord</a>
                                <a class="text-surface-700 dark:text-surface-100 mb-2 block cursor-pointer text-xl leading-normal">Events<img src="/demo/images/landing/new-badge.svg" class="ml-2"></a>
                                <a class="text-surface-700 dark:text-surface-100 mb-2 block cursor-pointer text-xl leading-normal">FAQ</a>
                                <a class="text-surface-700 dark:text-surface-100 block cursor-pointer text-xl leading-normal">Blog</a>
                            </div>
                            ...
                            <div class="col-span-12 md:col-span-3">
                                ...
                                <a class="text-surface-700 dark:text-surface-100 mb-2 block cursor-pointer text-xl leading-normal">Brand Policy</a>
                                <a class="text-surface-700 dark:text-surface-100 mb-2 block cursor-pointer text-xl leading-normal">Privacy Policy</a>
                                <a class="text-surface-700 dark:text-surface-100 block cursor-pointer text-xl leading-normal">Terms of Service</a>
                            </div>
                        </div>
                    </div>
                </div>
