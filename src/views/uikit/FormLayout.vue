            ...
            <div class="md:w-1/2">
                <div class="card flex flex-col gap-4">
                    ...
                    <div class="grid grid-cols-12 gap-2">
                        <label for="name3" class="col-span-12 mb-2 flex items-center md:col-span-2 md:mb-0">Name</label>
                        <div class="col-span-12 md:col-span-10">
                            <InputText id="name3" type="text" />
                        </div>
                    </div>
                    <div class="grid grid-cols-12 gap-2">
                        <label for="email3" class="col-span-12 mb-2 flex items-center md:col-span-2 md:mb-0">Email</label>
                        <div class="col-span-12 md:col-span-10">
