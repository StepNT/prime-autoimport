    ...
    <div class="card">
        ...
        <Carousel :value="products" :num-visible="3" :num-scroll="3" :responsive-options="carouselResponsiveOptions">
            <template #item="slotProps">
                <div class="border-surface-200 dark:border-surface-700 m-2 border rounded p-4">
                    <div class="mb-4">
                        <div class="relative mx-auto">
                            <img :src="`https://primefaces.org/cdn/primevue/images/product/${slotProps.data.image}`" :alt="slotProps.data.name" class="w-full rounded">
                            <div class="dark:bg-surface-900 rounded-border absolute" style="left: 5px; top: 5px">
