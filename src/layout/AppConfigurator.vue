...
<template>
    <div
        class="config-panel rounded-border border-surface dark:bg-surface-900 absolute right-0 top-[3.25rem] hidden w-64 origin-top border bg-gray-100 p-4 shadow-[0px_3px_5px_rgba(0,0,0,0.02),0px_0px_2px_rgba(0,0,0,0.05),0px_1px_4px_rgba(0,0,0,0.08)]"
    >
            ...
            <div>
                ...
                <div class="flex flex-wrap justify-between gap-2 pt-2">
                    <button
                        ...
                        class="h-5 w-5 cursor-pointer rounded-full border-none p-0 outline-offset-1 outline-none" :class="[{ 'outline-primary': layoutConfig.primary === primaryColor.name }]"
